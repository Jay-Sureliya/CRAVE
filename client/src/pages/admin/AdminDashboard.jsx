...
//         {/* --- 1. CLEAN SIDEBAR (Same style as Restaurant) --- */}
...
//                             trend="+5%" 
//                             icon={<DollarSign className="text-blue-500" size={20} />} // Reusing icon for layout
//                         />
//                         <SimpleStat 
...
//       isActive 
//         ? "bg-slate-100 text-slate-900 font-semibold" // Admin uses Slate accent instead of Orange for differentiation, or switch to Orange if preferred
//         : "text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium"
//     }`}
//   >
//     <div className="flex items-center gap-3">
//       <div className={isActive ? "text-slate-900" : "text-gray-400 group-hover:text-gray-600"}>
//         {icon}
//       </div>
//       <span>{label}</span>
//     </div>
...
//          isActive ? "bg-white text-slate-900 shadow-sm" : "bg-gray-100 text-gray-600"
//       }`}>
//         {count}
//       </span>
//     )}
    
//     {isActive && <div className="absolute left-0 w-1 h-8 bg-slate-900 rounded-r-full" />} 
//   </button>
// );
