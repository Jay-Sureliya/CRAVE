...
// import { ChefHat, Clock, CheckCircle, Bike, ShoppingBag, MapPin } from "lucide-react";
...
//                     // Prevent overwriting orders currently being interacted with
...
//         if (activeFilter === "pending") statusMatch = order.status === "pending";
//         else if (activeFilter === "preparing") statusMatch = ["accepted", "preparing"].includes(order.status);
//         else if (activeFilter === "ready") statusMatch = order.status === "ready";
//         else if (activeFilter === "history") statusMatch = ["out_for_delivery", "delivered", "cancelled"].includes(order.status);
...
//         <div>
//             {/* Filter Tabs */}
//             <div className="flex mb-8 bg-white p-1.5 rounded-2xl border border-gray-200 shadow-sm w-fit">
...
//                             {count > 0 && tab !== 'history' && (
//                                 <span className={`px-2 py-0.5 rounded-md text-[10px] ${activeFilter === tab ? 'bg-white/20' : 'bg-gray-100 text-gray-600'}`}>{count}</span>
//                             )}
//                         </button>
//                     );
//                 })}
...
//     const borderClass = { orange: 'border-orange-500', blue: 'border-blue-500', green: 'border-green-500', slate: 'border-gray-200' }[color];
...
//     return (
//         <motion.div layout initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className={`bg-white rounded-3xl border-2 shadow-sm relative overflow-hidden flex flex-col ${borderClass}`}>
//             <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-white">
//                 <div>
//                     <span className="bg-gray-100 text-gray-600 px-2.5 py-1 rounded-lg text-xs font-black tracking-wider">#{order.id}</span>
...
//                     <span className="text-xl font-black text-gray-900">₹{order.total_amount}</span>
//                 </div>
//             </div>
...
//                                 <span className="font-black text-gray-900 bg-white border border-gray-200 w-6 h-6 flex items-center justify-center rounded-md text-xs">{item.quantity}x</span>
//                                 <div>
...
//                                                 <span key={aIdx} className="text-[10px] bg-white text-gray-500 px-1.5 py-0.5 rounded border border-gray-200 font-bold">{addon}</span>
//                                             ))}
//                                         </div>
//                                     )}
//                                 </div>
...
//                     <div className="bg-white p-3.5 rounded-xl border border-gray-200 flex items-start gap-3 mb-2">
//                         <MapPin size={16} className="text-gray-400 mt-0.5 shrink-0" />
//                         <p className="text-xs text-gray-600 font-medium leading-relaxed">{order.delivery_address}</p>
//                     </div>
//                 )}
                
//                 {order.rider_name && (
//                     <div className="bg-purple-50 p-3.5 rounded-xl border border-purple-100 flex items-center gap-3 text-purple-700">
...
//                     <button onClick={() => onUpdate(order.id, "preparing")} className="w-full py-3.5 bg-black text-white rounded-xl font-bold text-sm hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 shadow-lg shadow-gray-200">
...
//                     <div className="text-center text-xs font-black text-gray-400 uppercase tracking-widest py-2">
