...
//         isAvailable: true,
//         image: null,
//         addons: [] // <--- NEW: Array to store addons
//     };
...
//         // Parse addons if they exist in DB
//         let parsedAddons = [];
//         if (item.addons) {
//             try {
...
//             image: null,
//             addons: parsedAddons // <--- Load existing addons
//         });
...
//         setTempAddon({ name: "", price: "" }); // Reset inputs
//     };
...
//     // ... (handleDelete and toggleStatus remain same as your code) ...
