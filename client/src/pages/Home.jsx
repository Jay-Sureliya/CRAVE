...
// import React from 'react';
// import { useNavigate } from 'react-router-dom'; // Imported for the tracking button redirect
// import b1 from '/b1.png'; // Make sure these paths match your project structure
// import b2 from '/b2.png';
// import b3 from '/b3.png';
// import Recommended from '../components/Recommended';
...
// const Home = () => {
//     // Initialize navigate for the redirect button
...
//             {/* --- LIVE ORDER TRACKER (Directly inside Home.jsx) --- */}
//             {/* The 'fixed bottom-8 left-1/2 -translate-x-1/2' classes lock it to the bottom center */}
//             <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-[100] w-[90%] max-w-lg">
//                 <div className="bg-white/95 backdrop-blur-md shadow-[0_10px_40px_rgba(0,0,0,0.15)] border border-gray-200 rounded-3xl p-3 pl-5 flex items-center justify-between gap-4">

//                     {/* Left Side: Pulse Indicator & Text */}
...
//                         className="bg-[#FF8A00] hover:bg-[#ff9f2e] text-white px-6 py-2.5 rounded-2xl font-bold text-sm transition-all shadow-md active:scale-95 whitespace-nowrap"
//                     >
//                         Track
//                     </button>
//                 </div>
