...
//   // --- 1. CALCULATE ITEM TOTAL (Updated to force Discount Price) ---
//   const itemTotal = cartItems.reduce((acc, item) => {
//     // Check if discount_price exists and is valid (greater than 0)
//     const hasDiscount = (item.discount_price || item.discountPrice) > 0;
