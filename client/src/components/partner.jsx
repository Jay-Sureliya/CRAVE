...
// 2. IMPORT ICONS
import { X, Store, Loader2, CheckCircle2 } from 'lucide-react';
// 3. IMPORT API (Critical for database connection)
...
const Partner = () => {
  ...
  // --- REAL API SUBMISSION (Updated from About.jsx) ---
              ...
              {!submitted ? (
                <>
                  <div className="text-center mb-6">
                    ...
                    <p className="text-gray-500 text-sm mt-2">Fill out the details below. Our admin team will review your request.</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea required name="address" value={formData.address} onChange={handleChange} rows="2" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition" placeholder="123 Food Street, City"></textarea>
                    </div>
                ...
                <div className="text-center py-10">
                  ...
                  <p className="text-gray-500">
                    ...
                    Once approved, you will receive your <strong>Login Credentials</strong> via email.
                  </p>
