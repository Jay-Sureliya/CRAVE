...
// const CheckoutModal = ({ isOpen, onClose, total, address, onSuccess }) => {
...
//                 {
//                     address: address || "Default Address (Update in Profile)",
//                     payment_method: method
//                 },
//                 { headers: { Authorization: `Bearer ${token}` } }
//             );

//             // Simulate Razorpay delay if selected
//             if (method === 'RAZORPAY') {
//                 setTimeout(() => {
//                     onSuccess();
//                     onClose();
...
//                                 className={`p-4 rounded-xl border-2 flex items-center justify-between cursor-pointer ${method === 'COD' ? 'border-orange-500 bg-orange-50' : 'border-stone-100'}`}
//                             >
//                                 <div className="flex items-center gap-3">
//                                     <div className="bg-green-100 p-2 rounded-full text-green-600"><Banknote size={20} /></div>
//                                     <span className="font-bold text-stone-700">Cash on Delivery</span>
//                                 </div>
//                                 {method === 'COD' && <CheckCircle className="text-orange-500" size={20} />}
//                             </div>

//                             {/* Option 2: Razorpay */}
//                             <div
//                                 onClick={() => setMethod('RAZORPAY')}
//                                 className={`p-4 rounded-xl border-2 flex items-center justify-between cursor-pointer ${method === 'RAZORPAY' ? 'border-orange-500 bg-orange-50' : 'border-stone-100'}`}
//                             >
//                                 <div className="flex items-center gap-3">
//                                     <div className="bg-blue-100 p-2 rounded-full text-blue-600"><CreditCard size={20} /></div>
//                                     <span className="font-bold text-stone-700">Pay Online (Razorpay)</span>
//                                 </div>
//                                 {method === 'RAZORPAY' && <CheckCircle className="text-orange-500" size={20} />}
//                             </div>
//                         </div>
...
//                             onClick={handleOrder}
//                             disabled={loading}
//                             className="w-full bg-stone-900 text-white py-4 rounded-xl font-bold text-lg flex justify-center items-center gap-2"
//                         >
